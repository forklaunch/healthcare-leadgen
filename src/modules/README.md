...
To access the full `MikroORM` CLI, run `pnpm mikro-orm`. Note, you may have to supply necessary NODE_ENV arguments to interface correctly with the target database.
